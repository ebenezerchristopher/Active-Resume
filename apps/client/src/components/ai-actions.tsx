...
import { changeTone } from "../services/geminiai/change-tone";
import { fixGrammar } from "../services/geminiai/fix-grammar";
import { improveWriting } from "../services/geminiai/improve-writing";
...
export const AiActions = ({ value, onChange, className }: Props) => {
  ...
  const aiEnabled = useGeminiAiStore((state) => !!state.apiKey);
