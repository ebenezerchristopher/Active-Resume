...
import { pageSizeMap } from "@active-resume/utils";
...
export const PublicResumePage = () => {
  ...
  useEffect(() => {
    ...
    return () => currentFrame?.removeEventListener("load", updateResumeInFrame);
