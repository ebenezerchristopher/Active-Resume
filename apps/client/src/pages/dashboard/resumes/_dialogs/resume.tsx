...
import { createResumeSchema } from "@active-resume/dto";
import { idSchema, sampleResume } from "@active-resume/schema";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export const ResumeDialog = () => {
  ...
  const onReset = useCallback(() => {
    ...
    if (isDelete)
      form.reset({ id: payload.item?.id, title: payload.item?.title, slug: payload.item?.slug });
  }, [isCreate, isUpdate, isDuplicate, isDelete, form, payload]);
