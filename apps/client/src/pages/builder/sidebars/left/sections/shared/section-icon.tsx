...
import type { SectionKey, SectionWithItem } from "@active-resume/schema";
import { defaultSection } from "@active-resume/schema";
import type { ButtonProps } from "@active-resume/ui";
import { Button, Tooltip } from "@active-resume/ui";
...
export const SectionIcon = ({ id, name, icon, size = 14, ...props }: SectionIconProps) => {
  ...
  return (
    <Tooltip side="right" content={(name || id) ?? section.name}>
